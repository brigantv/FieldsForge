...
For isolated systems, the fit of electric dipoles can also be performed. Its compilation requires the software suite MolForge and LAMMPS (tested on version 29 Sep 2021). For the lapack, scalapack and OpenMPI version, please refer to the MolForge software.
